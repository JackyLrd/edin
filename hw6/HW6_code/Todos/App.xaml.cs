...
namespace Todos
{
    ...
    sealed partial class App : Application
    {
        ...
        private void LoadDatabase()
        {
            ...
            string sql = "CREATE TABLE IF NOT EXISTS TodoItem (Id VARCHAR(140) PRIMARY KEY, Title VARCHAR(140), Description VARCHAR(140), Time VARCHAR(140), Imguri VARCHAR(140));";
